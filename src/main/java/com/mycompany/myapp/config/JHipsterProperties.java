...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "21punten@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "21punten API";

        private String description = "21punten API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "21punten";
